...
class Step3_Load_LinkedAccountantLog_Test(unittest.TestCase):
    def test_step_is_executed_correctly(self):
        # Arrange
        sql_data = execute_sql_query(OriginalStoredProcedureSQL.STEP_3_SQL)
    ...
    def execute_transformation_step(self):
        ...
        result_df = format_as_logs(result_df)
